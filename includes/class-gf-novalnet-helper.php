...
class GF_Novalnet_Helper {
	...
	public static function formatted_date( $date = '' ) {
		return date_i18n( get_option( 'date_format' ), strtotime( '' === $date ? current_time( 'Y-m-d' ) : $date ) );
	}
	...
	public static function get_payment_name( $payment_type ) {
		$payments = array(
			...
			'DIRECT_DEBIT_ACH'                       => array(
				'payment_name'   => __( 'Direct Debit ACH', 'novalnet-gravity-forms' ),
				'payment_method' => 'novalnet_direct_debit_ach',
			),
			'PAYCONIQ'                               => array(
				'payment_name'   => __( 'Payconiq', 'novalnet-gravity-forms' ),
				'payment_method' => 'novalnet_payconiq',
			),
			'BLIK'                                   => array(
				'payment_name'   => __( 'BLIK', 'novalnet-gravity-forms' ),
				'payment_method' => 'novalnet_blik',
			),
			'MBWAY'                                  => array(
				'payment_name'   => __( 'MB WAY', 'novalnet-gravity-forms' ),
				'payment_method' => 'novalnet_mbway',
			),
			'EPC_QRPAY'                              => array(
				'payment_name'   => __( 'EPC-QR-Pay', 'novalnet-gravity-forms' ),
				'payment_method' => 'novalnet_epc_qrpay',
			),
		);
