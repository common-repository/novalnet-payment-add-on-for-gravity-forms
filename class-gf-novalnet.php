...
class GF_Novalnet extends GFPaymentAddOn {
	...
	public function novalnet_redirect( $note ) {
		...
		$redirect_url        = GF_Novalnet_Helper::return_url();
	...
	public function redirect_url( $feed, $submission_data, $form, $entry ) {
		...
		if ( ! empty( $response['result']['status'] ) && 'SUCCESS' === $response['result']['status'] && ! empty( $response['result']['redirect_url'] ) ) { // Checking payment URL call is success or not.
